...
// base, 20260924130000_role_tresorier.sql). La matrice de permissions reste
// partagée avec requireGerant() ci-dessus : restreindre un de ces modules
// s'applique aux deux rôles.
